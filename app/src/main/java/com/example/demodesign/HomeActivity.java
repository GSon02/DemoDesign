...
import com.example.demodesign.DemoAdapter.ViewPagerAdapter_Demo;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setViewPager(){
        ViewPagerAdapter_Demo viewPagerAdapter_demo = new ViewPagerAdapter_Demo(getSupportFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
        viewPager.setAdapter(viewPagerAdapter_demo);
